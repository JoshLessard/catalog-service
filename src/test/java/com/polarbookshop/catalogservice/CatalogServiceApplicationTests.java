...
class CatalogServiceApplicationTests {
	...
	static void dynamicProperties( DynamicPropertyRegistry registry ) {
		registry.add(
			...
			() -> KEYCLOAK_CONTAINER.getAuthServerUrl() + "realms/PolarBookshop"
		);
	}
	...
	static void generateAccessTokens() {
		WebClient webClient = WebClient.builder()
			.baseUrl( KEYCLOAK_CONTAINER.getAuthServerUrl() + "realms/PolarBookshop/protocol/openid-connect/token" )
	...
	@Test
	public void whenPostRequestUnauthorizedThen403() {
		Book expectedBook = Book.of( "1231231231", "Title", "Author", 9.90, "Polarsophia" );
